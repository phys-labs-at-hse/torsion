...
\input{latex-tabulars/1.tex}
\input{latex-tabulars/2.tex}
\input{latex-tabulars/3.tex}
\input{latex-tabulars/4.tex}
\input{latex-tabulars/5.tex}
\input{latex-tabulars/6.tex}
\input{latex-tabulars/7.tex}
\input{latex-tabulars/8.tex}
\end{table}
...
По этим графикам можно посчитать коэффициент $k$:
% TODO: таблица с коэф-ами, их погрешностями и периодами
% TODO: посчитать модуль сдвига
